...
public final class CraftChatMessage {
    ...
    private static final class StringMessage {
        ...
        private void appendNewComponent(int index) {
            Component addition = new TextComponent(this.message.substring(currentIndex, index)).setStyle(modifier);
            this.currentIndex = index;
            if (this.currentChatComponent == null) {
                this.currentChatComponent = new TextComponent("");
                this.list.add(currentChatComponent);
            }
        ...
        if (component instanceof TranslatableComponent) {
            ...
            for (int i = 0; i < subs.length; i++) {
                ...
                if (comp instanceof Component) {
                    ...
                    subs[i] = CraftChatMessage.fixComponent(new TextComponent((String) comp), matcher);
                }
            }
        }
